...
namespace DAO.Utitlities
{
    public class DBHelper
    {
        ...
        public List<T> GetListSP<T>(string SPName, int timeOut, params SqlParameter[] Parameters)
        {
            var sqlCommand = new SqlCommand(SPName) { CommandType = CommandType.StoredProcedure };
            sqlCommand.CommandTimeout = timeOut;
            return GetList<T>(sqlCommand, Parameters);
        ...
        public T GetInstanceSP<T>(string SPName, int timeOut, params SqlParameter[] Parameters)
        {
            var sqlCommand = new SqlCommand(SPName) { CommandType = CommandType.StoredProcedure };
            sqlCommand.CommandTimeout = timeOut;
            return GetInstance<T>(sqlCommand, Parameters);
