...
namespace BookStore.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateOrder(RequestCreateOrderModel request)
        {
            ...
            var data = StoreOrderSqlInstance.Inst.CreateNewOrder(accountId, request.CustomerId, request.Type, request.Description, request.Barcodes, request.Numbers, request.VourcherId, request.PaymentMethod, out responseStatus);
